...
\begin{itemize}
\item \texttt{<label\_id>}: \texttt{u128} Stack pos
\end{itemize}
...
\begin{itemize}
\item \texttt{<vector\_id>}: \texttt{u128} Stack pos
\end{itemize}
...
\subsubsection{\texttt{PKV} --- \label{inst:pkv}}
...
\begin{itemize}
\item \texttt{stack args = $[TOS - count, ..., TOS: Scalar]$}: Input
\end{itemize}
...
\subsubsection{\texttt{PKL} --- \label{inst:pkl}}
...
\subsubsection{\texttt{UNPK} --- \label{inst:unpk}}
...
\begin{itemize}
\item \texttt{stack args = $[TOS: Vector|Labels]$}: Input
\end{itemize}

\noindent \textbf{Return}

\begin{itemize}
\item \texttt{result $[TOS - len, ..., TOS]$}: Output
\end{itemize}
...
\subsubsection{\texttt{VPUSH} --- \label{inst:vpush}}
...
\begin{itemize}
\item \texttt{stack args = $[TOS: Vector[0..len]$]}: Input
\end{itemize}

\noindent \textbf{Return}

\begin{itemize}
\item \texttt{result = $[TOS: Vector[0..len + 1]$]}: Output
\end{itemize}
...
\subsubsection{\texttt{VPOP} --- \label{inst:vpop}}
...
\subsubsection{\texttt{T} --- \label{inst:t}}

Transpose `count` vectors on stack $[V1, V2]$ -> $[T1, T2]$. In-place updates `count` operands from TOS by performing transform.
...
\begin{itemize}
\item \texttt{stack args = $[TOS - count, ..., TOS: Vector[0..len]$]}: Input
\end{itemize}

\noindent \textbf{Return}

\begin{itemize}
\item \texttt{result = $[TOS - len, ..., TOS: Vector[0..count]$]}: Output
\end{itemize}
...
\begin{itemize}
\item \texttt{result = $[TOS: 'A filtered mapped 'LB to 'LA]$}: Output
