...
\begin{itemize}
    ...
    \item[\texttt{\_Name}] In usage examples, names beginning with an underscore (e.g., \texttt{\_AssetWeights}) refer to dedicated VIL registers. These names are automatically associated with register indices by the \texttt{devil!()} procedural macro.
