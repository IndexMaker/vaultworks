...
abigen!(
    ...
    r"[
        ...
        function processTraderBuyOrder(uint128 vendor_id, uint128 index_id, address trader_address, uint128 max_order_size, bytes calldata asset_contribution_fractions) external returns (bytes memory, bytes memory, bytes memory)

        function processTraderSellOrder(uint128 vendor_id, uint128 index_id, address trader_address, uint128 max_order_size, bytes calldata asset_contribution_fractions) external returns (bytes memory, bytes memory, bytes memory)
        ...
        function executeBuyOrder(uint128 vendor_id, uint128 index_id, address trader_address, uint128 collateral_added, uint128 collateral_removed, uint128 max_order_size, bytes calldata asset_contribution_fractions) external returns (bytes memory, bytes memory, bytes memory)

        function executeSellOrder(uint128 vendor_id, uint128 index_id, address trader_address, uint128 collateral_added, uint128 collateral_removed, uint128 max_order_size, bytes calldata asset_contribution_fractions) external returns (bytes memory, bytes memory, bytes memory)
